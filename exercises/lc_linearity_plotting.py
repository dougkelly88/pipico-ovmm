...
ax.set_title('LC Linearity')
ax.set_xlabel('LC potentiometer Value (0-255)')
...
print("Saving data to 'lc_linearity_data.txt' in the 'data' directory.")
path = Path("data")
path.mkdir(exist_ok=True)
output_file = path.joinpath("lc_linearity_data.txt")
